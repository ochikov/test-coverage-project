...
const FoodCart = require('../build/FoodCart.json');
...
const deploy = async (network, secret) => {
	...
	// const verifyingTransaction = await result.contract.verifyProof(["0x284b28523024056fa7694a1936dddb134109e61396af7f29ca61d4f2fa0e4d18", "0x1babcd69c1b190e33aee053911a5f42f5650988116047f861a098f20ad2dca27"],
	...
	// const result2 = await deployer.deploy(FoodCart);

	// await result.contract.createLime('ogi', 1, 2, 3);
	// const transaction = await result2.contract.addFoodItem('Item1', 10);
	// await result2.verboseWaitForTransaction(transaction, 'test')

	// const provider = new ethers.providers.JsonRpcProvider('http://localhost:8545');
	// const result = await provider.getTransactionReceipt('0xfecc13dea238a856eebf16fa2c5e8b5becfbd458d7190393aaeac93d0f91baa4');
	// console.log(result);
